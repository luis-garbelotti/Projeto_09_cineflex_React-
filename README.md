...
This project allows you to reserve a seat in a section of a movie of your choice. You just have to choose the movie, select your preferred time and choose your seat! A great time to take a break with friends or just have a moment for yourself.

## About

This is a web application with which lots of people can reserve a seat in a movie session. Below are the implemented features:

- Select Movie
- Choose time session
- Find and reserve an empty seat

This project was made to test my knowledge in react routers and styled components.
